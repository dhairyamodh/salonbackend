...
const create = async (data) => {
    try {
        ...
        return ({ status: httpStatus.OK, message: 'Expense type Added Successfully' })
    } catch (error) {
        return ({ status: httpStatus.INTERNAL_SERVER_ERROR, message: error })
    }
}
...
const update = async (data) => {
    try {
        ...
        return ({ status: httpStatus.OK, message: 'Expense type Updated Successfully' })
    } catch (error) {
        return ({ status: httpStatus.INTERNAL_SERVER_ERROR, message: error })
    }
}
...
const remove = async (data) => {
    try {
        ...
        return ({ status: httpStatus.OK, message: 'Expense type Deleted Successfully' })
    } catch (error) {
        return ({ status: httpStatus.INTERNAL_SERVER_ERROR, message: error })
    }
}
